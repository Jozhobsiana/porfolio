<?php $this->load->view('admin_header', ['title' => 'Manage Tarpaulin Section']); ?>
<div class="main-content">
    <h1>Manage Tarpaulin Section</h1>

    <!-- Add Button -->
    <div style="margin-bottom: 15px;">
        <a href="<?= site_url('admin/tarpaulin_form') ?>" 
    ...
    <table id="table" class="display">
        ...
        <tbody>
            <?php foreach ($tarpaulin as $value): ?>
                <tr>
                    <td><?= $value['id'] ?></td>
                    <td>
                    ...
                    <td>
                        <a href="<?= site_url('admin/tarpaulin_form/' . $value['id']) ?>" 
                        ...
                        <a href="<?= site_url('admin/delete_tarpaulin/' . $value['id']) ?>"
