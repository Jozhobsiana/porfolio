<?php $this->load->view('admin_header', ['title' => 'Manage Ecommerce Section']); ?>
<div class="main-content">
    <h1>Manage Ecommerce Section</h1>

    <!-- Add Button -->
    <div style="margin-bottom: 15px;">
        <a href="<?= site_url('admin/ecommerce_form') ?>" 
    ...
    <table id="table" class="display">
        ...
        <tbody>
            <?php foreach ($ecommerce as $value): ?>
                <tr>
                    <td><?= $value['id'] ?></td>
                    <td>
                    ...
                    <td>
                        <a href="<?= site_url('admin/ecommerce_form/' . $value['id']) ?>" 
                        ...
                        <a href="<?= site_url('admin/delete_ecommerce/' . $value['id']) ?>"
