<?php $this->load->view('admin_header', ['title' => 'Manage Packaging Design Section']); ?>
<div class="main-content">
    <h1>Manage Packaging Design Section</h1>

    <!-- Add Button -->
    <div style="margin-bottom: 15px;">
        <a href="<?= site_url('admin/packaging_design_form') ?>" 
    ...
    <table id="table" class="display">
        ...
        <tbody>
            <?php foreach ($packaging_design as $value): ?>
                <tr>
                    <td><?= $value['id'] ?></td>
                    <td>
                    ...
                    <td>
                        <a href="<?= site_url('admin/packaging_design_form/' . $value['id']) ?>" 
                        ...
                        <a href="<?= site_url('admin/delete_packaging_design/' . $value['id']) ?>"
